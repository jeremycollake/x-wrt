...
<td width=50% height=266 background=/images/bg.gif><img src=/images/px1.gif width=1 height=1 border=0></td>
<td valign=bottom background=/images/bg_left.gif><img src=/images/bg_left.gif alt="" width=17 height=16 border=0></td><td valign=top>
<table border=0 cellpadding=0 cellspacing=0 width=780>
<tr valign=top><td width="522" height="347">
...
</td></tr><tr valign=bottom><td></td></tr>
</table>
</td><td valign=bottom background=/images/bg_right.gif><img src=/images/bg_right.gif alt="" width=17 height=16 border=0></td><td width=50% background=/images/bg.gif><img src=/images/px1.gif width=1 height=1 border=0></td></tr>
</table>
</body>
</html>
EOF
