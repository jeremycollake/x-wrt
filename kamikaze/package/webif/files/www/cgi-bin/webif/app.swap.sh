...
if ! empty "$FORM_remove"; then
	echo "<html><header></header><body><font size=3>Removing SWAP package ...<br><br><pre>"
...
<input type="submit" name="mapswap" value="Swap RAM">
</form><br>
EOF

else
echo "<font color="#33CC00">Swap is succesfully maped in $SET_PATH</font><br><br>"
fi
...
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr> 
	<td width="200px">&nbsp;<a href="" rel="b1">Swap file Location:</a></td>
	<td><input name="swap_path" type="text" value=$SET_PATH></td>
</tr>
<tr> 
	<td width="200px">&nbsp;<a href="" rel="b2">Size (blocks):</a></td>
	<td><input name="swap_ram" type="text" value=$SET_RAM></td>
</tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr> 
	<td>&nbsp;</td>
