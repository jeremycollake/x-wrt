    ...
    if equal $no_short_status "1"; then
        ...
        short_status_frame="<div id=\"short-status\">
                            ...
                            <ul>
                                ...
                                <li>
                                    <table><tr>
                                    <td class=\"swatch\" style=\"background: #000000; width: 15px; border: 1px solid #000;\">&nbsp;</td>
                                    <td class=\"swatch\" style=\"background: #192a65; width: 15px; border: 1px solid #000;\">&nbsp;</td>
                                    <td class=\"swatch\" style=\"background: #114488; width: 15px; border: 1px solid #000;\">&nbsp;</td>
                                    <td class=\"swatch\" style=\"background: #2b6d21; width: 15px; border: 1px solid #000;\">&nbsp;</td>
                                    <td class=\"swatch\" style=\"background: #e8ca9e; width: 15px; border: 1px solid #000;\">&nbsp;</td>
                                    <td class=\"swatch\" style=\"background: #ffffff; width: 15px; border: 1px solid #000;\">&nbsp;</td>
                                    </tr></table>
                                </li>
                           </ul>
                           </div>"
