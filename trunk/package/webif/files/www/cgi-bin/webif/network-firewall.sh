...
END {
	...
	print "<div class=\\"helptext\\">@TR<<firewall_help_fw_portrange|If you would like to forward port 999 TCP from the internet to a local computer at 192.168.100.1, it might look like below:>></div>"
	#print "</div>"
	print "<div class=\\"helptext\\">@TR<<firewall_help_fw_port_example|Destination ports: 999 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Target: 192.168.1.100 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Protocol: TCP>></div>"
	...
	print "<div class=\\"helptext\\">@TR<<firewall_help_fw_portrange_example|Destination ports: 2000-3000 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Target: 192.168.1.100 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Protocol: TCP>></div>"
