...
<tr><td>
@TR<<Cova_Credit|Some pages have been adopted from code written>> @TR<<by>> C0da, <a href="http://www.coova.org">Coova Technologies</a>, <a href="http://sourceforge.net/projects/hotspot-zone">Hotspot-Zone</a>, @TR<<and by>> <a href="http://www.picopoint.com">PicoPoint B.V.</a>
</td></tr>
<tr><td>
