...
helpitem|HotSpot RADIUS Server
helptext|Helptext HotSpot RADIUS Server#Primary and Secondary RADIUS Server
field|@TR<<RADIUS Secret>>|chilli_radiussecret
text|chilli_radiussecret|$FORM_chilli_radiussecret
helpitem|HotSpot RADIUS Secret
helptext|Helptext HotSpot RADIUS Secret#RADIUS Shared Secret
...
helpitem|HotSpot RADIUS NAS Id
helptext|Helptext HotSpot RADIUS NAS Id#RADIUS NAS Id
field|@TR<<Proxy Listen>>|chilli_proxylisten
text|chilli_proxylisten|$FORM_chilli_proxylisten
helpitem|HotSpot Proxy Listen
helptext|Helptext HotSpot Proxy Listen#IP Address to listen to (advanced uses only)
field|@TR<<Proxy Client>>|chilli_proxyclient
text|chilli_proxyclient|$FORM_chilli_proxyclient
helpitem|HotSpot Proxy Client
helptext|Helptext HotSpot Proxy Client#Clients from which we accept RADIUS Requests
field|@TR<<Proxy Port>>|chilli_proxyport
text|chilli_proxyport|$FORM_chilli_proxyport
helpitem|HotSpot Proxy Port
helptext|Helptext HotSpot Proxy Port#UDP port to listen to
field|@TR<<Proxy Secret>>|chilli_proxysecret
text|chilli_proxysecret|$FORM_chilli_proxysecret
helpitem|HotSpot Proxy Secret
helptext|Helptext HotSpot Proxy Secert#RADIUS Shared Secret to accept for all clients
end_form
EOF
