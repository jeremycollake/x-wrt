...
?>
<center>
	<object data="/cgi-bin/webif/graph_cpu_svg.sh"
		width="500" height="250" type="image/svg+xml" />
	<object>
		<br><a href=http://www.adobe.com/svg/viewer/install/main.html>@TR<<If the graph is not fuctioning download the viewer here.>></a>
	</object>
</center>
<? footer ?>
<!--
