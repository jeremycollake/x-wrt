...
uci.check_set("coovachilli","uam","HS_UAMFORMAT","http://$HS_UAMSERVER/cgi-bin/login/pba.lua")
...
if portal == 2 and userlevel < 2 then
  ...
  uci.set("coovachilli","uam","HS_UAMFORMAT","http://\$HS_UAMSERVER/cgi-bin/login/pba.lua")
...
function uam_form(form,user_level,localuam)
  ...
  if user_level > 1 and localuam < 2 then
    ...
    form:Add("text","coovachilli.uam.HS_UAMFORMAT",uci.check_set("coovachilli","uam","HS_UAMFORMAT","http://\$HS_UAMSERVER/cgi-bin/login/pba.lua"),tr("cportal_var_format#Path of Login Page"),"string","width:90%")
