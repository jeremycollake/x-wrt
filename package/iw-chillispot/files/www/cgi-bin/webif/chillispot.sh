...
----	Input Section form
	...
	form:Add("text",cfg_chilli..".net",chilli_val.net,tr("chilli_var_net#Network"),"string","width:99%")
	form:Add("text",cfg_chilli..".dynip",chilli_val.dynip,tr("chilli_var_dynip#Dynamic IP Pool"),"string","width:99%")
	form:Add("text",cfg_chilli..".dns1",chilli_val.dns1,tr("chilli_var_dns1#Primary DNS"),"string","width:99%")
	form:Add("text",cfg_chilli..".dns2",chilli_val.dns2,tr("chilli_var_dns2#Secondary DNS"),"string","width:99%")
	form:Add("text",cfg_chilli..".statip",chilli_val.statip,tr("chilli_var_statip#Static IP Pool"),"string","width:99%")
	form:Add("text",cfg_chilli..".dhcpmac",chilli_val.dhcpmac,tr("chilli_var_dhcpmac#DHCP MAC"),"string","width:99%")
	form:Add("text",cfg_chilli..".lease",chilli_val.lease,tr("chilli_var_lease#Lease"),"string","width:99%")
----	Help section	
	...
	form:Add_help(tr("chilli_var_dhcpmac#DHCP MAC"),tr("chilli_help_dhcpmac#An address in the range  00:00:5E:00:02:00 - 00:00:5E:FF:FF:FF falls within the IANA range of addresses and is not allocated for other purposes."))
...
----	Input Section form
	...
	form:Add("text",cfg_chilli..".radiusnasid",       chilli_val.radiusnasid,tr("chilli_var_radiusnasid#NAS ID"),"string","width:99%")
	form:Add("text",cfg_chilli..".radiusnasip",       chilli_val.radiusnasip,tr("chilli_var_radiusnasip#NAS IP"),"string","width:99%")
	form:Add("text",cfg_chilli..".radiusauthport",    chilli_val.radiusauthport,tr("chilli_var_radiusauthport#Authentication Port"),"string","width:99%")
	form:Add("text",cfg_chilli..".radiusacctport",    chilli_val.radiusacctport,tr("chilli_var_radiusacctport#Accounting Port"),"string","width:99%")
	...
	form:Add("text",cfg_chilli..".radiuslisten",      chilli_val.radiuslisten,tr("chilli_var_radiuslisten#Listen IP"),"string","width:99%")
	form:Add("text",cfg_chilli..".radiuscalled",      chilli_val.radiuscalled,tr("chilli_var_radiuscalled#Radius Called Station ID"),"string","width:99%")
----	Help section	
...
----	Input Section form
	...
	form:Add("text",cfg_chilli..".macpassword",chilli_val.macpassword,tr("chilli_var_macpassword#MAC Password"),"string","width:99%")
	form:Add("text",cfg_chilli..".macsuffix",chilli_val.macsuffix,tr("chilli_var_macsuffix#MAC Suffix"),"string","width:99%")
----	Help section	
...
----	Input Section form
	form:Add("text",cfg_chilli..".proxylisten",chilli_val.proxylisten,tr("chilli_var_proxylisten#Listen"),"string","width:99%")
	form:Add("text",cfg_chilli..".porxyport",chilli_val.proxyport,tr("chilli_var_proxyport#Port"),"string","width:99%")
	form:Add("text",cfg_chilli..".proxysecret",chilli_val.proxysecret,tr("chilli_var_proxysecret#Secret"),"string","width:99%")
	form:Add("text",cfg_chilli..".proxyclient",chilli_val.proxyclient,tr("chilli_var_proxyclient#Client"),"string","width:99%")
----	Help section	
...
----	Input Section form
	form:Add("text",cfg_chilli..".ipup",chilli_val.ipup,tr("chilli_var_ipup#IP Up"))
	form:Add("text",cfg_chilli..".ipdown",chilli_val.ipdown,tr("chilli_var_ipdown#IP Down"))
	form:Add("text",cfg_chilli..".conup",chilli_val.conup,tr("chilli_var_conup#Connection Up"))
	form:Add("text",cfg_chilli..".condown",chilli_val.condown,tr("chilli_var_condown#Connection Down"))
----	Help section	
...
----	Input Section form
	...
	form:Add("text",cfg_chilli..".confusername",chilli_val.confusername,tr("chilli_var_confusername#Conf username"),"string","width:99%")
	form:Add("text",cfg_chilli..".confpassword",chilli_val.confpassword,tr("chilli_var_confpassword#Conf password"),"string","width:99%")
...
----	Help section	
	...
	form:Add_help(tr("chilli_var_confuser_pass#Configuration Username and Password"),tr("chilli_help_confuser_pass#If confusername is specified together with confpassword chillispot will at regular intervals specified by the interval option query the radius server for configuration information."))
	formservice:print()
end
